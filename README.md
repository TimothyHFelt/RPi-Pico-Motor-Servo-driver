...
Description: This code is used to control 2 servos and motors for a RPI surveillance tank. It reads a UART and puts that into a Queue used to tell the Servos and Motors what to do. The Voltage Monitor task is used to monitor the system voltage, adjust the motor duty cycle to createsteady power as the voltage decreases, and to shut down the code if the voltage is sensed as low. \ \
